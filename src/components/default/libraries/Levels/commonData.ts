...
export const commonDataBlocks = {
  groups: 'levels?is_group=1&perPage=-1&isCommon=1&isShort=1',
  groups_similar: 'levels?is_group_similar=1&perPage=-1&isCommon=1&isShort=1',
  statuses: 'statuses?perPage=-1&entity_name=levels&block_name=Profile&isCommon=1&isShort=1',
