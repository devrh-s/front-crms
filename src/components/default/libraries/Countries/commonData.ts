...
export const commonDataBlocks = {
  groups: 'countries?is_group=1&perPage=-1&isCommon=1&isShort=1',
  groups_similar: 'countries?is_group_similar=1&perPage=-1&isCommon=1&isShort=1',
  flags: 'flags?perPage=-1&isCommon=1&isShort=1',
  statuses: 'statuses?perPage=-1&entity_name=countries&block_name=Profile&isCommon=1&isShort=1',
