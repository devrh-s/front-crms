...
interface IFiltersProps {
  ...
  handleSetFilters: (newFilters: IIndustryFilters) => void;
...
export default function IndustriesFilter({
  ...
  const generateFiltersData = () => {
    const filters: IIndustryFilters = {};
  ...
  }, [createdAt, createdByFilter, statusesFilter, groupFilter, prioritiesFilter, languageFilter]);
