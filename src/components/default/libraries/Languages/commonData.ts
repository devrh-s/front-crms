...
export const commonDataBlocks = {
  statuses: 'statuses?perPage=-1&entity_name=languages&block_name=Profile&isCommon=1&isShort=1',
  groups: 'languages?is_group=1&perPage=-1&isCommon=1&isShort=1',
  groups_similar: 'languages?is_group_similar=1&perPage=-1&isCommon=1&isShort=1',
