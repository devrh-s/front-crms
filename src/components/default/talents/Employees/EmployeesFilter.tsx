...
export interface IEmployeesFilters extends IPureFilters {
  is_student?: string;
}
...
interface IFiltersProps {
  ...
  handleSetFilters: (newFilters: IEmployeesFilters) => void;
...
export default function EmployeesFilter({
  ...
  const [task_templates, setTaskTemplatesFilter] = useState<IFilter>({
    value: [],
    mode: 'standard',
  });
  ...
  useEffect(() => {
    const generateFiltersData = () => {
      const filters: IEmployeesFilters = {};
