...
import Contacts from '@/components/default/talents/Presales/Presale/Contacts';
import Contents from '@/components/default/talents/Presales/Presale/Contents';
import CVs from '@/components/default/talents/Presales/Presale/CVs';
import Languages from '@/components/default/talents/Presales/Presale/Languages';
import Prices from '@/components/default/talents/Presales/Presale/Prices';
import Professions from '@/components/default/talents/Presales/Presale/Professions';
import Profile from '@/components/default/talents/Presales/Presale/Profile/Profile';
import Rates from '@/components/default/talents/Presales/Presale/Rates';
...
export default function PresaleProfile({ id }: { id: string }) {
  ...
  const {
    ...
    queryKey: ['presale', id],
    queryFn: async () => {
      const response = await apiGetData(`presales/${id}`);
      return response;
    },
    refetchOnWindowFocus: false,
    placeholderData: {
  ...
  useEffect(() => {
    if (tabsData) {
      ...
      const permissionTypeMap: Record<string, string> = {
        Professions: 'view_presales_professions',
        'Employee Rates': 'view_presales_rates',
        'Employee Salaries': 'view_presales_salaries',
        Prices: 'view_presales_prices',
        Languages: 'view_presales_languages',
        CVS: 'view_presales_cvs',
        Contacts: 'view_presales_contacts',
        Contents: 'view_presales_contents',
        Communications: 'view_presales_communications',
        Comments: 'view_presales_comments',
      };
        ...
        <>
          ...
          {data && (
            <Box>
              ...
              <Prices id={+id} isDisplayed={activeBookmark === TabsValues.PRICES} />
