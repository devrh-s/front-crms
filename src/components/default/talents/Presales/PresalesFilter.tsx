...
export interface IPresalesFilters extends IPureFilters {
  is_student?: string;
}
...
interface IFiltersProps {
  ...
  handleSetFilters: (newFilters: IPresalesFilters) => void;
...
export default function PresalesFilter({
  open,
  handleSetFilters,
  handleApplyFilters,
  toggleFilters,
  ...
  useEffect(() => {
    const generateFiltersData = () => {
      const filters: IPresalesFilters = {};
