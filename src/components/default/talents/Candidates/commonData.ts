...
export const commonDataBlocks: CommonDataBlocks = {
  ...
  statuses: 'statuses?perPage=-1&entity_name=Candidates&block_name=Profile&isShort=1&isCommon=1',
  tools: 'tools?perPage=-1&entity_name=Candidates&block_name=Contacts&isShort=1&isCommon=1',
  tools_candidates:
    'tools?perPage=-1&entity_name=Candidates&block_name=Profile&isShort=1&isCommon=1',
