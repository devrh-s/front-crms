...
import { IViewProps, IReportDaily } from './types';
...
function DailyCard({ elem }: IDailyCard) {
              ...
              {elem?.user?.name && (
                <CustomChip
                  ...
                  data={
                    {
                      name: elem?.user?.name,
                      image: elem?.user?.image ?? '/images/question_mark.svg',
                    } as any
                  }
                />
              )}
                ...
                {fieldsKeys.map((key) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        {key !== 'total' ? dayjs(key).format('DD-MM-YY') : key}
                      </Typography>
                      <Stack
                        flexDirection='row'
                        flexWrap={'wrap'}
