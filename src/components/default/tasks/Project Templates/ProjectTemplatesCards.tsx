...
interface IProjectTemplatesCard {
  elem: IProjectTemplate;
    ...
    <Grow in>
      ...
      >
        ...
        >
          ...
          >
            <Typography>Hours: {elem.hours}</Typography>
            <MoreChips data={elem.task_templates} />
            <MoreChips data={elem.milestone_templates} />
          </Box>
        </CardContent>
      </Card>
    </Grow>
...
export default function ProjectTemplatesCards({
  rows,
  searchValue,
  loading,
  view,
