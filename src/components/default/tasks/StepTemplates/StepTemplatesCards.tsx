    ...
    >
      ...
      >
        ...
        <Stack flexDirection='row' justifyContent='space-between' gap='1rem' flexGrow={1} sx={{}}>
          ...
          <Typography sx={{ textAlign: 'center' }}>{elem.hours_planned}</Typography>
        </Stack>
        ...
        {!isSmall && (
          <>
            <Stack sx={{ flex: 1, justifyContent: 'center' }}>
              <MoreChips data={elem.checklist_items} propName='name' />
            </Stack>
            <Stack flexDirection='row' justifyContent='space-between' alignItems='center'>
              <Box>
...
export default function StepTemplatesCards({
  rows,
  searchValue,
  paginationModel,
  pagePermissions,
