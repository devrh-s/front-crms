...
interface IMilestoneTemplatesCard {
  elem: IMilestoneTemplate;
...
function MilestoneTemplatesCard({
  elem,
  isSmall,
  isAdmin,
  pagePermissions,
        ...
        >
          <Stack flexDirection='row' justifyContent='space-between' alignItems='center'>
            ...
            <CardActionsButton
              ...
              url={`/milestone-templates/${elem.id}`}
            />
          </Stack>
          <Box
            sx={{
...
export default function MilestoneTemplatesCards({
  rows,
  searchValue,
  loading,
  view,
