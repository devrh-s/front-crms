...
function ContentsCard({ elem, handleActions, handleDeleteModal, url }: IStatusesProps) {
...
export default function ContentsCards({
  rows,
  url,
  searchValue,
  handleSearch,
