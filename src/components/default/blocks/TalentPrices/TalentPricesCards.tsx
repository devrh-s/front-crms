...
function PricesCard({ elem, handleActions, handleDeleteModal, isSmall }: IStatusesProps) {
...
export default function TalentPricesCards({
  rows,
  searchValue,
  handleSearch,
  paginationModel,
