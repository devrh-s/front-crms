...
function LanguageLevelsCard({ elem, handleActions, handleDeleteModal, url }: IStatusesProps) {
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              {elem.level?.name ? elem.level?.name : null}
            </Typography>
...
export default function LanguageLevelsCards({
  rows,
  searchValue,
  handleSearch,
  paginationModel,
