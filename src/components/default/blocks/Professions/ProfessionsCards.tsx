...
function ProfessionsCard({ elem, handleActions, handleDeleteModal, url }: IStatusesProps) {
...
interface IProps {
  rows: Array<IProfessionPriority>;
  view: string;
  url?: string;
  searchValue: string;
  loading?: boolean;
