...
function PricingTypeCard({ elem, isSmall, handleActions, handleDeleteModal }: IPricingTypesProps) {
...
export default function PricingTypesCards({
  rows,
  searchValue,
  handleSearch,
  paginationModel,
