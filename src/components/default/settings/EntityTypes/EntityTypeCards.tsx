...
function EntityTypeCard({ elem, handleActions, handleDeleteModal, isSmall }: IEntityTypeCard) {
...
export default function EntityTypeCards({
  rows,
  searchValue,
  handleSearch,
  toggleFilters,
