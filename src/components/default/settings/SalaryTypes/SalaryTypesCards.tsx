...
function SalaryTypesCard({ elem, isSmall, handleActions, handleDeleteModal }: ISalaryTypesCard) {
...
export default function SalaryTypesCards({
  rows,
  searchValue,
  handleSearch,
  toggleFilters,
