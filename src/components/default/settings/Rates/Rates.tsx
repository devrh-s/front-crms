...
const RateActions = dynamic(() => import('./RateActions'), {
  ssr: false,
});
...
export default function Rates() {
  ...
  const { isFetching, isError, data } = useQuery({
    queryKey: ['rates', { paginationModel, sortOptions, debouncedSearchValue }],
    queryFn: async () => {
      ...
      const response = await apiGetData(`rates?${searchParams}`);
      return response;
    },
    ...
    () => [
      {
        ...
        getActions: (params: { id: number }) => [
          ...
          <GridActionsCellItem
            ...
            onClick={() => handleClickCopy(`/rates/${params.id}`)}
            label='Copy'
            showInMenu
          />,
          <GridActionsCellItem
