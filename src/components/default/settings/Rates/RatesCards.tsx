...
import { IRate, IViewProps } from './types';
...
function RateCard({ elem, isSmall, handleActions, handleDeleteModal }: IRateCard) {
    ...
    <Grow in>
      ...
      >
        ...
        >
          ...
          <Stack flexDirection='row' justifyContent='center' gap='1rem' flexGrow={1}>
            <Typography fontWeight='700'>{elem.value}</Typography>
            <Divider color='black' orientation='vertical' flexItem />
            <Typography fontWeight='700'>{elem.hours}</Typography>
          </Stack>
        </CardContent>
      </Card>
    </Grow>
