...
function ContentTypeCard({ elem, isSmall, handleActions, handleDeleteModal }: IContentTypeCard) {
...
export default function ContentTypesCards({
  rows,
  searchValue,
  handleSearch,
  toggleFilters,
